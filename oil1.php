<html>
    <head>
        ...
        body{
            background:url("ghee.jpg")no-repeat center;
            width:100%;
            height:100vh;
    ...
    <body>
        <center>
           ...
           <?php
            ...
            $sql = "SELECT item_id,item_name,item_quantity,item_category,item_price FROM addingitems WHERE item_category='oils'";
...
<td><a href="grec.php?id=<?php echo $data['item_id']; ?>">Delete</a></td>
</tr>
<?php
}
?>
