<html>
    <head>
        ...
        body{
            background:url("fast1.jpg")no-repeat center;
            width:100%;
            height:100vh;
    ...
    <body>
        <center>
           ...
           <?php
            ...
            $sql = "SELECT item_id,item_name,item_quantity,item_category,item_price FROM addingitems WHERE item_category='fast foods'";
...
<td><a href="frec.php?id=<?php echo $data['item_id']; ?>">Delete</a></td>
</tr>
<?php
}
?>
